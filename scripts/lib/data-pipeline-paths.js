...
export const DATA_PATHS = {
  ...
  phase6SerieACompletionClubs: path.join(
    REPO_ROOT,
  ...
  phase8LaLigaCompletionClubs: path.join(
    REPO_ROOT,
    'editorial-overlays/phase8-la-liga-completion-clubs.json',
  ),
  phase9BundesligaCompletionClubs: path.join(
    REPO_ROOT,
    'editorial-overlays/phase9-bundesliga-completion-clubs.json',
  ),
  phase10EredivisieCompletionClubs: path.join(
    REPO_ROOT,
...
export function loadExpansionClubConfigs(options = {}) {
  ...
  const entries = [
    ...
    {
      path: DATA_PATHS.phase8LaLigaCompletionClubs,
      required: false,
      label: 'phase8-la-liga-completion',
    },
    {
      path: DATA_PATHS.phase9BundesligaCompletionClubs,
      required: false,
      label: 'phase9-bundesliga-completion',
    },
    {
      path: DATA_PATHS.phase10EredivisieCompletionClubs,
      required: false,
      label: 'phase10-eredivisie-completion',
    },
